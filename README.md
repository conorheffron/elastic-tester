...
## Technologies Used
- JDK 25, Elastic 9 (formerly ElasticSearch), & JEST Client 6
...
java -Djavax.net.ssl.trustStore=$TRUSTSTORE \
    ...
    -cp target/elastic-search-tester-3.6.4-RELEASE-jar-with-dependencies.jar net.ironoc.elastic.ElasticApp \
